export default function Footer() {
  ...
  <nav>
    ...
    <a className="link link-hover">Create Event</a>
  ...
  <nav>
    ...
    <a className="link link-hover">Concert</a>
    <a className="link link-hover">Musical</a>
    <a className="link link-hover">Play</a>
    <a className="link link-hover">Clasic</a>
  </nav>
  <nav>
